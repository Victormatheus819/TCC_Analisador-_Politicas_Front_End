<template>
    <v-container>
        ...
        <v-row justify="center">
            <v-col cols="12" md="9">
             <v-card color="light_grey" class=" my-auto mx-auto"  max-width="1000">
           ...
           <v-col cols="7" md="7" >
               <v-btn elevation="2"  color="swamp_green" @click="redirect()" class="white--text button floater" x-large> Realizar outra análise </v-btn>
           </v-col>    
        </v-row>
        <VLibras /> 
    </v-container>
